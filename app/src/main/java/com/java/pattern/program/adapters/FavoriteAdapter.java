...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.ViewHolder> {
    ...
    private ArrayList<FavoriteModel> mContentList;
    private ListItemClickListener mItemClickListener;

    public FavoriteAdapter(Context mContext, Activity mActivity, ArrayList<FavoriteModel> mContentList) {
    ...
    public void onBindViewHolder(FavoriteAdapter.ViewHolder mainHolder, int position) {
        final FavoriteModel model = mContentList.get(position);
