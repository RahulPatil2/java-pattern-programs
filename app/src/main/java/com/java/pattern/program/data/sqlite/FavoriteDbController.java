package com.java.pattern.program.data.sqlite;
...
public class FavoriteDbController {
    ...
    public int insertData(String postTitle, String postDetails) {
        ...
        if (c != null) {
            if (c.moveToFirst()) {
                do {
                    ...
                    favDataArray.add(new FavoriteModel(itemId, postTitle, postDetails));
                } while (c.moveToNext());
            }
            c.close();
        }
